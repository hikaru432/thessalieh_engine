...
try {
    const name = "20260815_salary_employee_rest_days.sql";
    ...
    const verify = await client.query(
        `SELECT column_name, data_type, is_nullable, column_default
          ...
          WHERE table_schema = 'public' AND table_name = 'salary_employees' AND column_name = 'rest_days'`,
    );
    console.log("salary_employees.rest_days:");
