...
/// GET /me/lb/projects/{id}/contract-split-history — read-only, whole project (a
/// contract's split history isn't scoped to any one subject, same as admin's version;
/// this Lead Broker already sees every contract in the project via list_project_contracts).
